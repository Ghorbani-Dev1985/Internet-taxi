...
exports.DatabasesModule = DatabasesModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({ providers: [postgres_service_1.PostgresService, redis_service_1.RedisService], exports: [postgres_service_1.PostgresService, redis_service_1.RedisService] })
], DatabasesModule);
